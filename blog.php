<html><head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="assets/allinone.php?css" type="text/css" media="screen">
...
<div id="header">
    ...
    <!-- Breadcrumb-->
    <div id="breadcrumbs">
        <a title="Blog" href="index.html">Blog</a>
        Listing
    </div>
    <!-- ENDS Breadcrumb-->
...
<div id="main">
    ...
    <div id="content">
        ...
        <!-- title -->
        <div id="page-title">
            <span class="title">A Blog</span>
            <span class="subtitle">Just another blog on the Internet...</span>
        </div>
        <!-- ENDS title -->
    ...
    <div id="twitter">
        ...
        <div id="tweets">
            ...
            <ul class="tweet_list" style="overflow: hidden;"><li class="tweet_first tweet_odd" style="position: absolute; top: 0px; left: 0px; display: block; z-index: 4; opacity: 1;"><span class="tweet_time"><a href="http://twitter.com/ansimuz/statuses/310233522050838530" title="view tweet on twitter">about 12 hours ago</a></span> <span class="tweet_text"><a href="http://twitter.com/ricosushi">@ricosushi</a> ya pronto tendre un nivel completo listo :)</span></li><li class="tweet_even" style="position: absolute; top: 0px; left: 0px; display: none; z-index: 2;"><span class="tweet_time"><a href="http://twitter.com/ansimuz/statuses/310192664207306752" title="view tweet on twitter">about 15 hours ago</a></span> <span class="tweet_text">Gameplay. Inside the forest temple <a href="https://t.co/7TMbCnxowT">https://t.co/7TMbCnxowT</a> showing some progress.</span></li><li class="tweet_odd" style="position: absolute; top: 0px; left: 0px; display: none; z-index: 1;"><span class="tweet_time"><a href="http://twitter.com/ansimuz/statuses/309177543444008960" title="view tweet on twitter">about 3 days ago</a></span> <span class="tweet_text">RT <a href="http://twitter.com/flypixel">@flypixel</a>: Icon Freebie: Soft Icon <a href="http://t.co/jKhg2EcbHv">http://t.co/jKhg2EcbHv</a></span></li></ul></div>
    </div>
    <!-- ENDS Twitter -->
...
<div id="footer">
    ...
    <ul id="footer-cols">
        <li class="col">
            ...
            This blog and page was created during (and for) workshopse which taken place at Politechnika Poznańska in 2013. It uses free template found on the Internat and created by <a href="http://www.luiszuno.com"> Luiszuno</a>.
        </li>
        <li class="col">
            <h6>About the workshops</h6>
            The workshops were organized by Politechnika Poznańska on Thursday 14th March 2013.
        </li>
        <li class="col">
            <h6>About Wikia</h6>
            Wikia operates the world’s largest network of collaboratively published video game, entertainment, and lifestyle content on the web through a trusted and customizable platform designed to help people share what they know and love. You can read more about us on <a href="http://www.wikia.com">our hompage</a>.
        </li>
    </ul>
    <!-- ENDS footer-cols -->
...
<script src="assets/allinone.php?js"></script>
